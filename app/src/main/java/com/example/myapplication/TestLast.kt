...
object SumCalculationPostfixSolver1 {
    ...
    //Функция для округление дробной части числа someRound до указанного количества знаков после запятой power
...
fun main() {
    ...
    println(SumCalculationPostfixSolver1.postfixExpression("2 3 + 1 -", mapRes))
}